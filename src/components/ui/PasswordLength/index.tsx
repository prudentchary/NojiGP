  ...
  return (
    <div className="w-full space-y-4 pt-2">
      <div>
        ...
        {/* Progress bar container background: Added dark:bg-slate-800 */}
        <div className="h-1.5 w-full bg-[#FCE7F3] dark:bg-slate-800 rounded-full overflow-hidden mb-3">
          <div
        ...
        {/* Hint Text: Added dark:text-slate-400 */}
        ...
        <div className="space-y-2.5">
          {rules.map((rule, index) => (
            <div key={index} className="flex items-center gap-2">
              <div
                className={`flex items-center justify-center w-[18px] h-[18px] rounded-[4px] border transition-all ${
                  rule.met
                    ? "bg-gradient-to-r from-[#18cfd2] to-[#1b7a7c] border-transparent"
                    : "bg-white border-slate-200 dark:bg-[#2A3441] dark:border-slate-700"
                }`}
              >
                {rule.met && (
