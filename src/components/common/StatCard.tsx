    ...
    return (
        <div className={cn(
            ...
            <div className="flex justify-between items-start">
                <span className="text-[14px] font-semibold text-slate-500  tracking-tight leading-none  dark:text-white">
                    {label}
                </span>
            </div>
            ...
            <div className="flex items-end justify-between">
                <div className="flex flex-col gap-1">
                    <span className="text-3xl font-bold leading-none dark:text-white">{value}</span>
                </div>

                <div className="flex flex-col items-end gap-2">
                    {percentage && (
                        <div className="flex items-center gap-1 text-slate-500 mb-1">
                            <span className="text-[12px] font-semibold  dark:text-white">{percentage}</span>
