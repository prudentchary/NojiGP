...
const LoginForm: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[520px] bg-white rounded-[10px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500 dark:bg-[#1F262E]">
        {/* Header */}
        ...
        <div className="px-8 pb-10">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-5">
              ...
              <div className="space-y-2 text-left">
                ...
                <div className="flex justify-end pt-1">
                  <Link
                    to="/forgot-password"
                    className="text-sm font-bold text-[#0D9488] hover:text-[#0C8075] transition-colors duration-200 dark:text-[#00f3f9]"
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <Button
              type="submit"
              // Beautiful dynamic toggle using your built-in theme design tokens!
