    ...
    const onSubmit = async (data: LoginFormValues) => {
        ...
        setTimeout(() => {
            if (data.email === "admin@example.com" && data.password === "password123") {
                ...
                toastError("Incorrect password and email combination");
                setError("email", { type: "manual", message: " " });
                setError("password", { type: "manual", message: "Incorrect password and email combination" });
        ...
        >
            ...
            <div className="relative w-full max-w-[520px] bg-white rounded-[10px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="flex justify-between items-center px-8 pt-8 pb-4">
                    ...
                    <Link to="/" className="text-slate-400 hover:text-slate-600 transition-colors p-1">
                        <X className="size-5" />
                    </Link>
                </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <Input
                                    ...
                                    variant="filled"
                                    {...register("email", { onChange: () => clearErrors(["email", "password"]) })}
                            ...
                            <div className="space-y-2 text-left">
                                <Input
                                    ...
                                    placeholder="************"
                                    variant="filled"
                                    {...register("password", { onChange: () => clearErrors(["email", "password"]) })}
