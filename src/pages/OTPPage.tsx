            ...
            <div className="relative w-full max-w-[536px] bg-white rounded-[10px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="px-8 pb-10">
                    <p className="text-[14px] leading-relaxed text-slate-400 mb-8 whitespace-pre-line">
                        A 6 digit OTP has been sent to <span className="font-bold text-slate-500">john@organisation1.com</span>{"\n"}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-between items-center px-0.5">
                            ...
                            <span className={cn(
                                ...
                                Expires in: <span className={cn("font-bold transition-colors duration-200", error ? "text-rose-500" : "text-slate-900")}>{formatTime(timeLeft)}</span>
                            </span>
                        </div>
                        ...
                        <div className="flex justify-center pt-2">
                            <button
                                type="button"
                                onClick={() => success("Verification code resent to your email!")}
